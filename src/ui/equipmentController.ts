...
export interface EquipmentSnapshot { readonly equipped: Readonly<Record<string, string | undefined>>; readonly owned: readonly { readonly instanceId: string; readonly equipmentId: string; readonly name: string; readonly setName: string; readonly setPieces: number; readonly slot: string; readonly tier: number; readonly iconArtId: string; readonly effectSummary: readonly string[]; readonly comparisonSummary?: string; readonly upgradeCost?: number; readonly upgradeLocked?: boolean }[]; readonly blueprints: readonly { readonly equipmentId: string; readonly name: string; readonly setName: string; readonly slot: string; readonly iconArtId: string; readonly fabricationCost: number; readonly effectSummary: readonly string[] }[]; readonly activeSets: readonly { readonly name: string; readonly pieces: number; readonly activeThresholds: readonly (2 | 4)[]; readonly bonusSummary: readonly string[] }[]; readonly unavailable: readonly { readonly instanceId: string; readonly equipmentId: string }[]; }
