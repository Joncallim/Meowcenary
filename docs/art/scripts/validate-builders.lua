...
local contracts = {
  ...
  {
    script = "docs/art/scripts/build-volt-lynx.lua",
    width = 48, height = 48, frames = 16,
    layers = { "body", "face", "outfit", "weapon", "shadow", "notes" },
    hidden = { weapon = true, shadow = true, notes = true },
    populated = { "body", "face", "outfit", "notes" },
    tags = { idle = { 1, 4 }, run = { 5, 10 }, hurt = { 11, 12 }, defeat = { 13, 16 } },
    savedAs = "assets-src/characters/volt-lynx/source/volt-lynx.pxo",
  },
  {
    script = "docs/art/scripts/build-brass-boar.lua",
    width = 48, height = 48, frames = 16,
    layers = { "body", "face", "outfit", "weapon", "shadow", "notes" },
    hidden = { weapon = true, shadow = true, notes = true },
    populated = { "body", "face", "outfit", "notes" },
    tags = { idle = { 1, 4 }, run = { 5, 10 }, hurt = { 11, 12 }, defeat = { 13, 16 } },
    savedAs = "assets-src/characters/brass-boar/source/brass-boar.pxo",
  },
  {
    script = "docs/art/scripts/build-ember-cougar.lua",
    width = 48, height = 48, frames = 16,
    layers = { "body", "face", "outfit", "weapon", "shadow", "notes" },
    hidden = { weapon = true, shadow = true, notes = true },
    populated = { "body", "face", "outfit", "notes" },
    tags = { idle = { 1, 4 }, run = { 5, 10 }, hurt = { 11, 12 }, defeat = { 13, 16 } },
    savedAs = "assets-src/characters/ember-cougar/source/ember-cougar.pxo",
  },
  {
    script = "docs/art/scripts/build-scrap-weasel.lua",
    width = 48, height = 48, frames = 16,
    layers = { "body", "face", "outfit", "weapon", "shadow", "notes" },
    hidden = { weapon = true, shadow = true, notes = true },
    populated = { "body", "face", "outfit", "notes" },
    tags = { idle = { 1, 4 }, run = { 5, 10 }, hurt = { 11, 12 }, defeat = { 13, 16 } },
    savedAs = "assets-src/characters/scrap-weasel/source/scrap-weasel.pxo",
  },
  {
    script = "docs/art/scripts/build-rattle-raptor.lua",
    width = 48, height = 48, frames = 16,
    layers = { "body", "face", "outfit", "weapon", "shadow", "notes" },
    hidden = { weapon = true, shadow = true, notes = true },
    populated = { "body", "face", "outfit", "notes" },
    tags = { idle = { 1, 4 }, run = { 5, 10 }, hurt = { 11, 12 }, defeat = { 13, 16 } },
    savedAs = "assets-src/characters/rattle-raptor/source/rattle-raptor.pxo",
  },
  {
    script = "docs/art/scripts/build-piston-ram.lua",
    width = 48, height = 48, frames = 16,
    layers = { "body", "face", "outfit", "weapon", "shadow", "notes" },
    hidden = { weapon = true, shadow = true, notes = true },
    populated = { "body", "face", "outfit", "notes" },
    tags = { idle = { 1, 4 }, run = { 5, 10 }, hurt = { 11, 12 }, defeat = { 13, 16 } },
    savedAs = "assets-src/characters/piston-ram/source/piston-ram.pxo",
  },
  {
